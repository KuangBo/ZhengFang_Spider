...
from ZhengFang_System_Spider import check_img
from ZhengFang_System_Spider import check_predict
...
class ZFSpider:
    ...
    def login(self):
        ...
        with open('./cache/xra6.png', 'wb') as f:
            f.write(img_res.content)
        # image = Image.open('./cache/check.png')
        # image.show()
        # 处理验证码并放到字典
        check_img.process()
        self.postData_land['TextBox3'] = check_predict.predict()
